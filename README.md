# Offshore-Wind-Research-2024-2025
...
│                         offshore_wind_nj and configuration for tools like black
│
...
│
└── offshore_wind_nj   <- Source code for use in this project.
    │
    ├── __init__.py             <- Makes offshore_wind_nj a Python module
    │
